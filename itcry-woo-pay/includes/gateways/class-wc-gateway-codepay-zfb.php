<?php
/**
 * ITCRY WOOPAY - Codepay Alipay Gateway
 */
...
class ITCRY_WOOPAY_Gateway_Codepay_ZFB extends ITCRY_WOOPAY_Abstract_Gateway {

    /**
     * 构造函数
     */
    public function __construct() {
        $this->id                 = 'itcry_woo_pay_codepay_zfb';
        $this->gateway_type       = 'codepay';
        $this->icon               = ITCRY_WOOPAY_URL . 'assets/logo/zfb-logo.jpg';
        $this->method_title       = __( '码支付 - 支付宝', 'itcry-woo-pay' );
        $this->method_description = __( '使用码支付提供的支付宝接口进行付款。', 'itcry-woo-pay' );
