<?php
/**
 * ITCRY WOOPAY - Easypay WeChat Gateway
 */
...
class ITCRY_WOOPAY_Gateway_Easypay_WX extends ITCRY_WOOPAY_Abstract_Gateway {

    /**
     * 构造函数
     */
    public function __construct() {
        $this->id                 = 'itcry_woo_pay_easypay_wx';
        $this->gateway_type       = 'easypay';
        $this->icon               = ITCRY_WOOPAY_URL . 'assets/logo/wx-logo.jpg';
        $this->method_title       = __( '易支付 - 微信支付', 'itcry-woo-pay' );
        $this->method_description = __( '使用易支付聚合接口进行微信支付付款。', 'itcry-woo-pay' );
